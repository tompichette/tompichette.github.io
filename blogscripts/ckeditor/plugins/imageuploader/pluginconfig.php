...
$useruploadfolder = $CONFIG["folder_name"]."userfiles/images";
$useruploadpath = $usersiteroot."$useruploadfolder/";
// files upload folder
$filesuploadfolder = $CONFIG["folder_name"]."userfiles/files/";
$filesuploadpath = $usersiteroot."$filesuploadfolder";
