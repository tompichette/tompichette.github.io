...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<td width='22px'><input type='text' name='hour' maxlength=2 size=1 style=\"width:32px\" value=" + showHour + " onkeyup=\"javascript:Cal.SetHour(this.value)\">";
		...
		if (Cal.ShowSeconds)
		{
			...
			vCalTime += "<input type='text' name='second' maxlength=2 size=1 style=\"width: 32px\" value=" + Cal.Seconds + " onkeyup=\"javascript:Cal.SetSecond(parseInt(this.value,10))\">";
		}
